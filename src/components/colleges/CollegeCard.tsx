...
export function CollegeCard({ college, onCompareToggle, isInCompare }: CollegeCardProps) {
  return (
    <Card className="group overflow-hidden border border-border/60 hover:border-primary/40 hover:shadow-lg transition-all duration-300 hover:-translate-y-0.5">
      {/* Image */}
      <div className="relative h-44 overflow-hidden bg-muted">
        ...
        {/* NIRF Badge */}
        {college.nirf_rank && (
          <div className="absolute top-3 left-3 flex items-center gap-1 rounded-full bg-black/70 px-2.5 py-1 text-xs font-semibold text-white backdrop-blur-sm">
      ...
      <CardContent className="p-4">
        ...
        <div className="flex gap-2 mt-3 pt-3 border-t border-border/50">
          <Link
            ...
            className="flex-1 inline-flex items-center justify-center rounded-md bg-primary/10 text-primary px-3 py-2 text-xs font-semibold hover:bg-primary/20 transition-colors"
          >
            View Details
          </Link>
          {onCompareToggle && (
            <button
              ...
              className={`flex-1 inline-flex items-center justify-center rounded-md border px-3 py-2 text-xs font-semibold transition-colors ${
                isInCompare
